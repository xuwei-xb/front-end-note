...
export type TableCellButtonProps<I extends InlineContentSchema = DefaultInlineContentSchema, S extends StyleSchema = DefaultStyleSchema> = {
    ...
    table: DefaultBlockSchema["table"];
}, I, S>["tableHandles"], undefined>, "freezeHandles" | "unfreezeHandles">;
