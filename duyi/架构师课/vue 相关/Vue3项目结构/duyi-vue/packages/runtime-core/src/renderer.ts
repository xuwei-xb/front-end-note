import { isString, isArray, isObject, isOn, ShapeFlags } from "@vue/shared";
...
export function shouldSetAsProps(el:any, key:string, value:any) {
  // 特殊处理
...
export function createRenderer<
  ...
  function patchKeyedChildren(oldVNode:any, newVNode:any, container:any) {
  ...
  function patch(oldVNode: any, newVNode:any, container:any, anchor = null) {
    ...
    if (typeof type === "string") {
      ...
      if (!oldVNode) {
        ...
        newVNode.children.forEach((child:any) => patch(null, child, container));
      } else {
  ...
  function unmount(vnode:any) {
    ...
    if (vnode.type === Fragment) {
      vnode.children.forEach((child:any) => unmount(child));
      return;
    }
